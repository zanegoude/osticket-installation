 ...
 <h1>osTicket - Setup and Installation</h1>
 ...
 - In the Control Panel, under Programs, click “Uninstall a program”. This will open the Programs and Features menu.
   > <img src="https://github.com/user-attachments/assets/4ad0f34e-d942-42d0-b5b4-a72368d9033f" height="50%" width="50%"/>
 ...
 - In the Windows Features directory, locate Internet Information Services and enable it by checking the box next to it.
   > <img src="https://github.com/user-attachments/assets/78277d87-3101-4d93-926b-65fd6894725d" height="30%" width="30%"/>
 ...
 - Click Close when the installation finishes.
   > <img src="https://github.com/user-attachments/assets/47ad74b4-7629-444f-a40c-8154759ed4a2" height="40%" width="40%"/>
 ...
 - In the installation wizard, read the License Agreement and select “I accept the terms in the License Agreement” then click Install.
   > <img src="https://github.com/user-attachments/assets/361d14cc-db74-42b6-9b0f-b7aca312aadf" height="40%" width="40%"/>
 - If the UAC shows up, click Yes.
 ...
 - Create a folder in the C:\ drive named “PHP”.
   > <img src="https://github.com/user-attachments/assets/599db2f8-6409-4892-97f1-b32f462370cc" height="40%" width="40%"/>
 ...
 - In the installation wizard, read the License Agreement and select “I agree to the license terms and conditions” then click Install.
   > <img src="https://github.com/user-attachments/assets/bd105adb-02d5-4ddc-b118-28ff4b171158" height="40%" width="40%"/>
 - If the UAC shows up, click Yes.
 - Click Close when the installation finishes.
 ...
 - In the installation wizard, click Next.
   > <img src="https://github.com/user-attachments/assets/5ba89953-1789-412f-be92-5572afcb4c00" height="40%" width="40%"/>
 ...
 - In the MySQL Server Instance Configuration Wizard, click Next.
   > <img src="https://github.com/user-attachments/assets/91bc96a9-95e1-4723-911f-a9a0642ab206" height="40%" width="40%"/>
 ...
 - In Security Options, make sure Modify Security Settings is selected and input the password you want for your root server account. Make sure you write this down so you don’t forget it. The username will be “root”.
   > <img src="https://github.com/user-attachments/assets/a55b1740-c638-4e39-8997-b4d450698d79" height="40%" width="40%"/>
 ...
 - In the IIS Manager, locate and open PHP Manager in the middle panel.
   > <img src="https://github.com/user-attachments/assets/78a9ffe6-f069-4635-a53d-a8233f5c32bd" height="50%" width="50%"/>
 ...
 - In the wwwroot folder, rename upload to “osTicket”.
   > <img src="https://github.com/user-attachments/assets/90c59848-ad33-4bcd-a7f0-0056efb27fed" height="50%" width="50%"/>
 ...
 - Under PHP Extensions, click on “Enable or disable an extension”.
   > <img src="https://github.com/user-attachments/assets/6aa506d4-2a65-41f6-bc0d-16a24f36b8af" height="50%" width="50%"/>
 ...
 - Find the file “ost-sampleconfig.php” and rename it to “ost-config.php”.
   > <img src="https://github.com/user-attachments/assets/8d3956f8-6a4a-4284-af49-45430bbebe24" height="50%" width="50%"/>
 ...
 - From the osTicket Home in IIS Manager, select “Browse” in the Actions panel on the right.
   > <img src="https://github.com/user-attachments/assets/4dc4455d-aa8c-45c4-a581-55ec39a87fb6" height="50%" width="50%"/>
 ...
 - In the installation wizard, read the License Agreement and select “I accept the agreement” then click Next.
   > <img src="https://github.com/user-attachments/assets/2ab9bd9d-7127-41a2-9d26-4d32e2e112f2" height="40%" width="40%"/>
 ...
 - In the bottom left corner of the HeidiSQL Session Manager window click New
   > <img src="https://github.com/user-attachments/assets/ba0348e3-0323-4dfb-8100-d0bfdf7acd68" height="50%" width="50%"/>
 ...
 <p>
 <img src="https://github.com/user-attachments/assets/1bd9a732-5417-4d39-a3fb-6fb85a228ed4" height="60%" width="60%"/>
 </p>
